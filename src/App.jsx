  ...
  return (
    <>
      ...
      <StorySection
        ...
        calloutNum="35+"
        calloutLabel={<>recruiting professionals<br />managing fragmented processes</>}
      >
        <InputCard
          icon="users"
      ...
      <StorySection
        ...
        calloutNum="3 hrs"
        calloutLabel={<>of engineering time<br />recovered per assessment</>}
      >
        <InputCard
          icon="clock"
      ...
      <StorySection
        ...
        calloutNum="2,200"
        calloutLabel={<>total hours saved<br />across all departments</>}
      >
        <InputCard
          icon="dollar"
